...
const skillGroups: SkillGroup[] = [
  { label: 'Core', icon: '✦', center: [170, 340], skills: ['HTML', 'CSS', 'JavaScript', 'Bootstrap 5'] },
  { label: 'Frameworks', icon: '◆', center: [470, 110], skills: ['jQuery', 'Laravel', 'Next.js', 'React'] },
  { label: 'Back-end & Data', icon: '●', center: [790, 340], skills: ['PHP', 'SQL', 'Python', 'Networking'] },
  { label: 'Tools', icon: '▲', center: [1080, 110], skills: ['Git', 'VS Code', 'Power BI', 'Excel'] },
];
...
export default function Skills() {
  ...
  return (
    <section ref={sectionRef} id="skills" className="relative z-10 px-[6vw] py-32">
      ...
      <svg viewBox="0 0 1200 460" className="w-full" style={{ maxHeight: '520px' }}>
        <defs>
              ...
              return (
                ...
                >
                  ...
                  <circle
                    ...
                    style={{
                      animation: `twinkle 3.2s ease-in-out ${twinkleDelay}s infinite`,
                    }}
                  />
                  <text
                    x={x}
                    y={y - 16}
                    textAnchor="middle"
                    className="fill-[#8E9096] font-garamond text-[18px] transition-all duration-300 group-hover:fill-[#F5F5F7]"
                  >
                    {skill}
                  </text>
                </g>
